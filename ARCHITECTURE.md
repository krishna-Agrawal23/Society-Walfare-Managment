# Architecture: Arihant Plaza Society Management System

## Overview

A full-stack society management web application for **Arihant Plaza** housing society (~40 flats). The system handles maintenance collection via Razorpay (₹7850/month + ₹100 late fee), lift emergency alerts via email, complaints with image uploads, asset tracking, and a dedicated watchman portal. Built with Next.js 14 + Express.js + MongoDB, deployed on Vercel + Render.
...
```
Subject: 🏠 Maintenance Due - {Month} {Year} | Arihant Plaza
...
Regards,
Arihant Plaza Society
```

### 2. Payment Reminder (Day 10)
```
Subject: ⏰ Reminder: Maintenance Payment Pending | Arihant Plaza
...
```
Subject: ⚠️ Final Notice: Pay Before Late Fee Applies | Arihant Plaza
...
```
Subject: ✅ Payment Received - Thank You! | Arihant Plaza
...
```
Subject: 🚨 LIFT EMERGENCY - Arihant Plaza
...
---
This is an automated alert from Arihant Plaza Society Management System.
```

### 6. Emergency Resolved
```
Subject: ✅ Lift Emergency Resolved | Arihant Plaza
...
```
Subject: 🔐 Password Reset OTP | Arihant Plaza
...
```
Subject: 📋 Complaint Status Updated | Arihant Plaza
...
This architecture document provides a comprehensive blueprint for building the Arihant Plaza Society Management System. All major decisions have been documented with rationale, and the system is designed for future extensibility.
