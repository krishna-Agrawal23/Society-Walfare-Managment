# Plan: Arihant Plaza Society Management System

A complete society management web app with **Next.js 14 + Express.js + MongoDB**, featuring Razorpay payments (₹7850/month + ₹100 late fee), Brevo email alerts, OTP password reset, ImageKit uploads, and watchman portal. Fully responsive for mobile & desktop.
...
- Subject: "🏠 Maintenance Due - January 2026 | Arihant Plaza"
- Body: Flat number, amount (₹7850), due date, payment link
