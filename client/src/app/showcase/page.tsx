          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button 
                ...
                asChild
              >
                <a href="https://github.com/krishna-Agrawal23/Society-Walfares-and-Managment" target="_blank" rel="noopener noreferrer">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-white font-bold text-lg">Arihant Plaza</p>
            ...
            <div className="flex items-center gap-6">
              <a 
                href="https://github.com/krishna-Agrawal23/Society-Walfares-and-Managment" 
                target="_blank" 
