...
The Express.js REST API backend for Arihant Plaza Society Management System.
...
**Production URL:** [Society-Walfares-and-Managment-zjlf.onrender.com](https://Society-Walfares-and-Managment-zjlf.onrender.com)

**Health Check:** [/api/health](https://Society-Walfares-and-Managment-zjlf.onrender.com/api/health)
...
# Run container
docker run -p 4000:4000 --env-file .env society-api
```
