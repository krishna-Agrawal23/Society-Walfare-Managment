...
exports.sendPaymentConfirmation = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      ...
      htmlContent: `
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 10px 10px 0 0;">
            <h1 style="color: white; margin: 0; text-align: center;">Arihant Plaza Society</h1>
          ...
          <div style="background: #f9f9f9; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
            ...
            <p style="color: #999; font-size: 12px; text-align: center; margin-bottom: 0;">
              This is an automated email from Arihant Plaza Society Management System.<br>
      ...
      `,
      textContent: `
        Payment Confirmation - Arihant Plaza Society
...
exports.sendMaintenanceReminder = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9f9f9; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
            ...
            <p style="color: #999; font-size: 12px; text-align: center;">
              Arihant Plaza Society Management System
            </p>
          </div>
        </body>
        </html>
      `,
      textContent: `
        ${urgencyText}: Maintenance Payment - Arihant Plaza Society
...
exports.sendMaintenanceInvoice = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email, name }],
      subject: `Maintenance Invoice - ${monthName} ${year} | Arihant Plaza Society`,
      htmlContent: `
        <!DOCTYPE html>
        <html>
        <head>
...
exports.sendEmergencyAlert = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email, name }],
      subject: '🚨 LIFT EMERGENCY ALERT - Arihant Plaza Society',
      htmlContent: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #fef2f2; padding: 30px; border: 2px solid #dc2626; border-top: none; border-radius: 0 0 10px 10px;">
            ...
            <p style="color: #999; font-size: 12px; text-align: center;">
              This is an automated emergency alert from Arihant Plaza Society.
            </p>
          </div>
        </body>
        </html>
      `,
      textContent: `
        🚨 LIFT EMERGENCY ALERT - Arihant Plaza Society
...
exports.sendEmergencyResolved = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email, name }],
      subject: '✅ Lift Emergency Resolved - Arihant Plaza Society',
      htmlContent: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f0fdf4; padding: 30px; border: 2px solid #16a34a; border-top: none; border-radius: 0 0 10px 10px;">
            ...
            <p style="color: #999; font-size: 12px; text-align: center;">
              This is an automated notification from Arihant Plaza Society.
            </p>
          </div>
        </body>
        </html>
      `,
      textContent: `
        ✅ LIFT EMERGENCY RESOLVED - Arihant Plaza Society
...
exports.sendComplaintStatusUpdate = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      ...
      `,
      textContent: `
        Complaint Status Update - Arihant Plaza Society
...
exports.sendPasswordResetOTP = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email, name }],
      subject: 'Password Reset OTP - Arihant Plaza Society',
      htmlContent: `
        <!DOCTYPE html>
        <html>
        <head>
      ...
      `,
      textContent: `
        Password Reset OTP - Arihant Plaza Society
...
exports.sendPasswordResetConfirmation = async (data) => {
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email, name }],
      subject: 'Password Changed Successfully - Arihant Plaza Society',
      htmlContent: `
        <!DOCTYPE html>
        <html>
        <head>
      ...
      `,
      textContent: `
        Password Changed Successfully - Arihant Plaza Society
